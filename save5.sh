...
show_docker_menu() {
        ...
        echo "This program helps you to run the commands and get output."
        echo "Example : if you type 1 and press enter, the output is displaced on the terminal"
        echo   "                Press 1: To show the Docker images list.
                Press 2: To show the Active running Containers.
		Press 3: To show all the Containers including stopped.
                Press 4: To pull a docker image.
                Press 5: To create a detachable Container/OS.
                Press 6: To remove a Container/OS.
                Press 7: To enter into a Container.
                Press 8: To Start a Container.
                Press 9: To stop a Container.
                Press 10: To Create a Customized image.
                Press 11: To create a database Container/OS.
		Press 12: To Create a Image to run Backend OS/Container.
	        Press 13: To Create a Container which runs on port 5000	"
}
...
command_run() {
	...
	if [[ $enteredNo -eq 1 ]];
        ...
        then
                ...
                echo `rmdir $rmdire` && echo "directory $rmdire removed successfully!" || echo "Failed to remove Directory $rmdire";
	elif [[ $enteredNo -eq 9 ]];
        then
        ...
        then
                ...
                echo `rm -f $rmfile.txt` && echo "file $rmfile.txt removed successfully!";
	elif [[ $enteredNo == "exit" ]];
        then
                echo "exiting...!"
		return;
...
docker_command_run() {
	...
	do
        ...
        then
                read -p "enter name of container: "  nameofcontainer
                read -p "enter the existing image name and version: " existingimage
                docker run -dit -p 5000:5000 --name $nameofcontainer $existingimage && echo "Container created Successfully...!" || echo "Failed to create Container...!";
	elif [[ $dockerNo == "exit" ]];
	then
		echo "exiting...!"
		return
...
while : ;
do
	echo "Press 1 to run a Linux command."
	echo "Press 2 to check Ram Space status."
